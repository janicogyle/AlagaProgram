...
function getThreshold() {
  return normalizeScore(process.env.NEXT_PUBLIC_FACE_VERIFICATION_THRESHOLD, 0.65);
}

function getMinFaceConfidence() {
  return normalizeScore(process.env.NEXT_PUBLIC_FACE_VERIFICATION_MIN_FACE_CONFIDENCE, 0.7);
}
