...
/**
 * Preview/query the next assistance control number.
 * The database enforces assistance_requests.control_number globally, so the
 * sequence must be global per year rather than per assistance type.
 */
